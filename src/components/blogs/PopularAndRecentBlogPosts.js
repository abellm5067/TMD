...
export default () => {
  ...
  const popularPosts = [
    ...
    {
      postImageSrc:
        "https://as1.ftcdn.net/v2/jpg/03/43/50/58/1000_F_343505809_2lgrInKJxyEGVibsmy6e5NXXqirXFPm7.jpg",
  ...
  const recentPosts = [
    {
      postImageSrc:
        "https://www.alert-software.com/hubfs/desktop_scrolling_message_software.png",
      title:
    ...
    {
      postImageSrc:
        "https://www.alert-software.com/hs-fs/hubfs/SS_2_2%20(2)-min.png?width=450&height=440&name=SS_2_2%20(2)-min.png",
    ...
    {
      postImageSrc:
        "https://files.priority-software.com/media/filer_public_thumbnails/filer_public/1b/35/1b356a72-713c-43a0-bfa3-85cacfd11087/asset-26.png__722x499_q85_subsampling-2.png",
    ...
    {
      postImageSrc:
        "https://files.priority-software.com/media/filer_public_thumbnails/filer_public/7a/4e/7a4e218e-21c5-4d14-ba68-8b6709d40084/news2x.png__1874x1320_q85_subsampling-2.png",
